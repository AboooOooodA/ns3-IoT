...
print("\nCsma Nodes: "+str(nbNode)+" "+distance+" "+pcktSize+" "+nbRetransmission+" "+traffic+"\n")  
...
for index in range(seedMax):
	fichier = open("results/N/"+str(distance)+"/N"+str(nbNode)+"/"+model+"N"+str(nbNode)+distance+nbRetransmission+pcktSize+traffic+seed+str(index+1)+".out", "r")
	for line in fichier:	
...
probaStream.write("Csma Nodes: "+str(nbNode)+" "+distance+" "+pcktSize+" "+nbRetransmission+" "+traffic+"\n\n")
