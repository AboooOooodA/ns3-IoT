...
model="AlohaNoAckSCRIPTEnergyDelay"
distance="D100"
pcktSize="P64"
...
EnergyConfInt="AlohaEnergy"+"N"+str(nbNode)+distance+nbRetransmission+pcktSize+traffic+"ConfInt.out"
DelayConfInt="AlohaDelay"+"N"+str(nbNode)+distance+nbRetransmission+pcktSize+traffic+"ConfInt.out"
